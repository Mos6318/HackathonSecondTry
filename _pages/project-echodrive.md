...
.project-hero {
  ...
  margin-right: -50vw;
  height: 60vh;
  background-image: url('{{ site.baseurl }}/assets/images/Echo_drive.png');
...
<div class="project-hero">
  <div class="hero-text-container">
    <h1 class="project-title-large">Echo Drive</h1>
    <div class="project-meta">
      <span><strong>Role:</strong> UX Researcher</span>
      <span>|</span>
      <span><strong>Tools:</strong> Miro, UserTesting</span>
      <span>|</span>
